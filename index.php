...
<body>
  ...
  <div class="container">
	  <div class="row">
        ...
        <!-- <button type="submit" class="btn btn-lg btn-block submitButton" id="submit">Continue with Facebook</button> -->
        <!-- <div class="fb-login-button btn-lg btn-block" data-max-rows="1" data-size="large" data-button-type="continue_with" data-show-faces="false" data-auto-logout-link="false" data-use-continue-as="true"></div> -->
